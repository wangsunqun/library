package com.wsq.library.json.util.jackson;
...
public class JacksonUtil {
    ...
    public static <V> V from(URL url, Class<V> type) {
        try {
            ...
            throw new RuntimeException("jackson from error, url: " + url.getPath() + ", type: " + type, e);
        }
    }
    ...
    public static <V> V from(InputStream inputStream, Class<V> type) {
        try {
            ...
            throw new RuntimeException("jackson from error, type: " + type, e);
        }
    }
    ...
    public static <V> V from(File file, Class<V> type) {
        try {
            ...
            throw new RuntimeException("jackson from error, file path: " + file.getPath() + ", type: " + type, e);
        }
    }
    ...
    public static <V> V from(String json, Type type) {
        ...
        try {
            ...
            throw new RuntimeException("jackson from error, json: " + json + ", type: " + type, e);
        }
    }
    ...
    public static <V> String to(List<V> list) {
        try {
            ...
            throw new RuntimeException("jackson to error, data: " + list, e);
        }
    }
    ...
    public static <V> String to(V v) {
        try {
            ...
            throw new RuntimeException("jackson to error, data: " + v, e);
        }
    }
    ...
    public static <V> void toFile(String path, List<V> list) {
        try (Writer writer = new FileWriter(new File(path), true)) {
            ...
            throw new RuntimeException("jackson toFile error, path: " + path + ", list: " + list, e);
        }
    }
    ...
    public static <V> void toFile(String path, V v) {
        try (Writer writer = new FileWriter(new File(path), true)) {
            ...
            throw new RuntimeException("jackson toFile error, path: " + path + ", data: " + v, e);
        }
    }
    ...
    public static String getAsString(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsString error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static int getAsInt(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsInt error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static long getAsLong(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsLong error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static double getAsDouble(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsDouble error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static BigInteger getAsBigInteger(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsBigInteger error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static BigDecimal getAsBigDecimal(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsBigDecimal error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static boolean getAsBoolean(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsBoolean error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static byte[] getAsBytes(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsBytes error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static <V> V getAsObject(String json, String key, Class<V> type) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsObject error, json: " + json + ", key: " + key + ", type: " + type, e);
        }
    }
    ...
    public static <V> List<V> getAsList(String json, String key, Class<V> type) {
        ...
        try {
            ...
            throw new RuntimeException("jackson getAsList error, json: " + json + ", key: " + key + ", type: " + type, e);
        }
    }
    ...
    public static JsonNode getAsJsonObject(String json, String key) {
        try {
            ...
            throw new RuntimeException("jackson getAsJsonObject error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static <V> String add(String json, String key, V value) {
        try {
            ...
            throw new RuntimeException("jackson add error, json: " + json + ", key: " + key + ", value: " + value, e);
        }
    }
    ...
    public static String remove(String json, String key) {
        try {
            ...
            throw new RuntimeException("jackson remove error, json: " + json + ", key: " + key, e);
        }
    }
    ...
    public static <V> String update(String json, String key, V value) {
        try {
            ...
            throw new RuntimeException("jackson update error, json: " + json + ", key: " + key + ", value: " + value, e);
        }
    }
    ...
    public static String format(String json) {
        try {
            ...
            throw new RuntimeException("jackson format json error, json: " + json, e);
        }
    }
