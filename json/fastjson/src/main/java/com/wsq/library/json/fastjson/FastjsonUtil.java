package com.wsq.library.json.fastjson;
...
public class FastjsonUtil {
    ...
    public static void main(String[] args) {
        String a = "{\"name\":\"wsq\",\"id\":123}";
        T t = JSON.parseObject(a, T.class);
    ...
    public static <V> V from(InputStream inputStream, Class<V> type) {
        try {
            ...
            throw new RuntimeException("fastjson from error, type: " + type, e);
        }
    }
    ...
    public static <V> V from(InputStream inputStream, TypeReference<V> typeReference) {
        try {
            ...
            throw new RuntimeException("fastjson from error, type: " + typeReference, e);
        }
    }
    ...
    public static String getAsString(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException(String.format(String.format("fastjson get string error, json: %s, key: %s", json, key), e));
        }
    }
    ...
    public static int getAsInt(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("fastjson get int error, json: %s, key: %s", json, key), e);
        }
    }
    ...
    public static long getAsLong(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("fastjson get long error, json: %s, key: %s", json, key), e);
        }
    }
    ...
    public static double getAsDouble(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("fastjson get double error, json: %s, key: %s", json, key), e);
        }
    }
    ...
    public static BigInteger getAsBigInteger(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("fastjson get big integer error, json: %s, key: %s", json, key), e);
        }
    }
    ...
    public static BigDecimal getAsBigDecimal(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("fastjson get big decimal error, json: %s, key: %s", json, key), e);
        }
    }
    ...
    public static boolean getAsBoolean(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("fastjson get boolean error, json: %s, key: %s", json, key), e);
        }
    }
    ...
    public static byte getAsByte(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("fastjson get bytes error, json: %s, key: %s", json, key), e);
        }
    }
    ...
    public static <V> V getAsObject(String json, String key, Class<V> type) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("fastjson get list error, json: {}, key: {}, type: " + json, key, type, e));
        }
    }
    ...
    public static JSONObject getAsJsonObject(String json, String key) {
        ...
        try {
            ...
            throw new RuntimeException(String.format("fastjson get list error, json: %s, key: %s", json, key), e);
        }
    }
